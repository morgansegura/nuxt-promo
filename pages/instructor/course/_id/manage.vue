    ...
    methods: {
        updateCourse() {
            this.$store.dispatch('instructor/course/updateCourse')
                .then(_ => this.$toasted.success('Course has been successfully updated!', {duration: 3000}))
                .catch(error => this.$toasted.error(`Course cannot be updated: ${error.message}`, {duration: 3000}))
        },
